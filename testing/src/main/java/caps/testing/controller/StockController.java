...
public class StockController {
    ...
    //팀 별 재고 등록하는 API
    @PostMapping(value = "/api/stock/{team_id}", consumes = MediaType.APPLICATION_JSON_VALUE)
    ...
    //팀 별 재고 삭제하는 API
    @PostMapping(value = "/api/stock/delete/{team_id}", consumes = MediaType.APPLICATION_JSON_VALUE)
    public String stock_delete(@PathVariable("team_id") Long team_id){
        stockService.deleteStock(team_id);
        return "삭제 완료";
    }
}
